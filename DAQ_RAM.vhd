...
-- Module  Version: 6.5
--C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n DAC_RAM -lang vhdl -synth lse -bus_exp 7 -bb -arch xo2c00 -type bram -wp 10 -rp 0011 -rdata_width 8 -data_width 8 -num_rows 1024 -cascade 11 -mem_init0 
...
architecture Structure of DAC_RAM is
    ...
    attribute MEM_LPC_FILE of DAC_RAM_0_0_0_0 : label is "DAC_RAM.lpc";
    attribute MEM_INIT_FILE of DAC_RAM_0_0_0_0 : label is "INIT_ALL_0s";
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of DAC_RAM is
    for Structure
