...
-- Module  Version: 6.5
--C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n DAQ_RAM -lang vhdl -synth lse -bus_exp 7 -bb -arch xo2c00 -type bram -wp 10 -rp 0011 -rdata_width 8 -data_width 8 -num_rows 8192 -cascade 11 -mem_init0 
...
architecture Structure of DAQ_RAM is
    ...
    attribute MEM_LPC_FILE of DAQ_RAM_0_0_0_7 : label is "DAQ_RAM.lpc";
    attribute MEM_INIT_FILE of DAQ_RAM_0_0_0_7 : label is "INIT_ALL_0s";
    attribute MEM_LPC_FILE of DAQ_RAM_0_0_1_6 : label is "DAQ_RAM.lpc";
    attribute MEM_INIT_FILE of DAQ_RAM_0_0_1_6 : label is "INIT_ALL_0s";
    attribute MEM_LPC_FILE of DAQ_RAM_0_0_2_5 : label is "DAQ_RAM.lpc";
    attribute MEM_INIT_FILE of DAQ_RAM_0_0_2_5 : label is "INIT_ALL_0s";
    attribute MEM_LPC_FILE of DAQ_RAM_0_0_3_4 : label is "DAQ_RAM.lpc";
    attribute MEM_INIT_FILE of DAQ_RAM_0_0_3_4 : label is "INIT_ALL_0s";
    attribute MEM_LPC_FILE of DAQ_RAM_0_0_4_3 : label is "DAQ_RAM.lpc";
    attribute MEM_INIT_FILE of DAQ_RAM_0_0_4_3 : label is "INIT_ALL_0s";
    attribute MEM_LPC_FILE of DAQ_RAM_0_0_5_2 : label is "DAQ_RAM.lpc";
    attribute MEM_INIT_FILE of DAQ_RAM_0_0_5_2 : label is "INIT_ALL_0s";
    attribute MEM_LPC_FILE of DAQ_RAM_0_0_6_1 : label is "DAQ_RAM.lpc";
    attribute MEM_INIT_FILE of DAQ_RAM_0_0_6_1 : label is "INIT_ALL_0s";
    attribute MEM_LPC_FILE of DAQ_RAM_0_0_7_0 : label is "DAQ_RAM.lpc";
    attribute MEM_INIT_FILE of DAQ_RAM_0_0_7_0 : label is "INIT_ALL_0s";
...
begin
    ...
    DAQ_RAM_0_0_0_7: DP8KC
        ...
        port map (DIA8=>scuba_vlo, DIA7=>scuba_vlo, DIA6=>scuba_vlo, 
            ...
            ADA12=>WrAddress(12), ADA11=>WrAddress(11), 
            ADA10=>WrAddress(10), ADA9=>WrAddress(9), ADA8=>WrAddress(8), 
            ADA7=>WrAddress(7), ADA6=>WrAddress(6), ADA5=>WrAddress(5), 
            ADA4=>WrAddress(4), ADA3=>WrAddress(3), ADA2=>WrAddress(2), 
            ADA1=>WrAddress(1), ADA0=>WrAddress(0), CEA=>WrClockEn, 
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of DAQ_RAM is
    for Structure
